        ...
        <div class="row">
          ...
          <div class="col-lg-8 pr-lg-6">
            <div class="d-flex align-items-center justify-content-between pb-2 mb-4">
              ...
              <a href="catalogo.php"><strong>Seguir comprando</strong></a>
            </div>
          ...
          <div class="media align-items-center">
            ...
            <div class="bg-secondary rounded mb-5">
                    ...
                    <div class="media-body w-100 pl-3">
                      <div class="d-sm-flex">
                        ...
                        <div class="d-flex pr-sm-3">
                          ...
                          <div class="text-nowrap pt-2"><strong class="text-danger">$<?php echo number_format($precio, 2); ?></strong> <s class="font-size-xs text-muted">$<?php echo number_format(($precio / 4.0), 2); ?></s></div>
                        </div>
              ...
              <div class="px-3 px-sm-4 py-4 text-right">
                <span class="text-muted">Total:<strong class="text-dark font-size-lg ml-2">$198.65</strong></span>
              </div>
            </div>
